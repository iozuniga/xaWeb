...
CLASS WDocMain FROM WDoc
   ...
   METHOD Act_EventMethod( hEvent )
   METHOD Act_RowClick( hEvent )
...
METHOD CreateDoc() CLASS WDocMain
   ...
   */
   ...
   ECHO "<h2>XailerWeb - Table with row click events</h2>" INTO Self

   WITH OBJECT ::oLbx := WListbox():New( Self )
   ...
   WITH OBJECT ::oText := WText():New (Self )
      :cId := "rowInfo"
...
METHOD Act_EventMethod( hEvent ) CLASS WDocMain
...
METHOD Act_RowClick( hEvent ) CLASS WDocMain
...
METHOD Srv_Magic( hParams ) CLASS WDocMain
   ...
   ::oText:cText := "<p>Recno: " + hParams[ 'detail-recno' ] + ;
      " Resolved in Harbour+Fetch (application/javascript) <b>XailerWeb magic!</b>"
