...
#define ODBC_FS_NAME           1     /* Name of column */
#define ODBC_FS_TABLE          2     /* Table of column if column was a field */
#define ODBC_FS_DEF            3     /* Default value*/
#define ODBC_FS_TYPE           4     /* Type of field. */
#define ODBC_FS_LENGTH         5     /* Width of column */
#define ODBC_FS_NULLEABLE      6     /* Nulleable*/
#define ODBC_FS_DECIMALS       7     /* Number of decimals in field */
#define ODBC_FS_HB_TYPE        8     /* HB Type */
#define ODBC_FS_HB_INIT        9     /* HB init value */
